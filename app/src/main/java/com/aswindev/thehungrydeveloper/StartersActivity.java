    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                new Dish("Mushroom and tofu maki",
                        "Mushroom and Tofu Maki is a delightful sushi dish that combines the earthy flavors of mushrooms with the subtle, creamy texture of tofu.",
                        999),
                new Dish("Egg and Avocado Uramaki",
                        "A sushi roll with creamy avocado and soft-boiled egg, wrapped in seaweed and rice",
                        1199),
